...
# Image loading
x_rej= batch_load("data/faces/")
x_acc = batch_load("data/alfonso_cuaron/")
...
# Save new files
np.save("data/x_file.npy", x, allow_pickle=False)
np.save("data/y_file.npy", y, allow_pickle=False)
'''
...
model.add(layers.Conv2D(64, (4, 4), activation='relu', input_shape=(256, 256, 3)))
...
# Save model
#tf.keras.models.save_model(model, "models/demo.h5")
